...
earth = pyrad.Planet(profileName, 1013.25, 300, rangeMin=500, rangeMax=900, initialThickness=initialThickness)
...
earth.addLapseRate('mesopause', mesopause, earth.temperatureAtHeight(mesopause), top, 190, earth.pressureAtHeight(mesopause))
...
earth.addCompositionRate('WV stratosphere and up', wvCP5, earth.compositionAtHeight(wvCP5, h2o), top, 0, h2o)
